...
<head>
    ...
    <!-- Scripts -->
    <script src="{{ asset('js/bootstrap.esm.js') }}" defer></script>
    ...
    <link href="{{ asset('css/bootstrap-reboot.rtl.css') }}" rel="stylesheet">
    <link href="{{ asset('css/bootstrap-utilities.css') }}" rel="stylesheet">
    <link href="{{ asset('css/bootstrap-utilities.rtl.css') }}" rel="stylesheet">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', 'Teste FullStack') }}
                </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('register') }}">{{ __('Cacastrar') }}</a>
                                </li>
                            @endif
                        @else
